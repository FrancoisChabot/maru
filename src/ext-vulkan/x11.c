...
MARU_Status maru_getVkExtensions_X11(MARU_Context *context, MARU_ExtensionList *out_list) {
  (void)context;
  (void)out_list;
  return MARU_FAILURE;
}

MARU_Status maru_createVkSurface_X11(MARU_Window *window, 
                                 VkInstance instance,
...
MARU_API MARU_Status maru_createVkSurface(MARU_Window *window, 
  ...
  return maru_createVkSurface_X11(window, instance, out_surface);
}
