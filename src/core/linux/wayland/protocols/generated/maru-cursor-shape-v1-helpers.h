...
#ifndef MARU_WAYLAND_HELPERS_CURSOR_SHAPE_V1_H
#define MARU_WAYLAND_HELPERS_CURSOR_SHAPE_V1_H
...
static inline void
maru_wp_cursor_shape_manager_v1_set_user_data(MARU_Context_WL *ctx, struct wp_cursor_shape_manager_v1 *wp_cursor_shape_manager_v1, void *user_data)
{
	ctx->dlib.wl.proxy_set_user_data((struct wl_proxy *) wp_cursor_shape_manager_v1, user_data);
}

static inline void *
maru_wp_cursor_shape_manager_v1_get_user_data(MARU_Context_WL *ctx, struct wp_cursor_shape_manager_v1 *wp_cursor_shape_manager_v1)
{
	return ctx->dlib.wl.proxy_get_user_data((struct wl_proxy *) wp_cursor_shape_manager_v1);
}

static inline uint32_t
maru_wp_cursor_shape_manager_v1_get_version(MARU_Context_WL *ctx, struct wp_cursor_shape_manager_v1 *wp_cursor_shape_manager_v1)
{
	return ctx->dlib.wl.proxy_get_version((struct wl_proxy *) wp_cursor_shape_manager_v1);
}

static inline int
maru_wp_cursor_shape_manager_v1_add_listener(MARU_Context_WL *ctx, struct wp_cursor_shape_manager_v1 *wp_cursor_shape_manager_v1, const struct wp_cursor_shape_manager_v1_listener *listener, void *data)
{
	return ctx->dlib.wl.proxy_add_listener((struct wl_proxy *) wp_cursor_shape_manager_v1, (void (**)(void)) listener, data);
}

static inline void
maru_wp_cursor_shape_manager_v1_destroy(MARU_Context_WL *ctx, struct wp_cursor_shape_manager_v1 *wp_cursor_shape_manager_v1)
{
...
maru_wp_cursor_shape_manager_v1_get_pointer(MARU_Context_WL *ctx, struct wp_cursor_shape_manager_v1 *wp_cursor_shape_manager_v1, struct wl_pointer *pointer)
{
	struct wl_proxy *id;
...
static inline struct wp_cursor_shape_device_v1 *
maru_wp_cursor_shape_manager_v1_get_tablet_tool_v2(MARU_Context_WL *ctx, struct wp_cursor_shape_manager_v1 *wp_cursor_shape_manager_v1, struct zwp_tablet_tool_v2 *tablet_tool)
{
	struct wl_proxy *id;
...
static inline void
maru_wp_cursor_shape_device_v1_set_user_data(MARU_Context_WL *ctx, struct wp_cursor_shape_device_v1 *wp_cursor_shape_device_v1, void *user_data)
{
	ctx->dlib.wl.proxy_set_user_data((struct wl_proxy *) wp_cursor_shape_device_v1, user_data);
}

static inline void *
maru_wp_cursor_shape_device_v1_get_user_data(MARU_Context_WL *ctx, struct wp_cursor_shape_device_v1 *wp_cursor_shape_device_v1)
{
	return ctx->dlib.wl.proxy_get_user_data((struct wl_proxy *) wp_cursor_shape_device_v1);
}

static inline uint32_t
maru_wp_cursor_shape_device_v1_get_version(MARU_Context_WL *ctx, struct wp_cursor_shape_device_v1 *wp_cursor_shape_device_v1)
{
	return ctx->dlib.wl.proxy_get_version((struct wl_proxy *) wp_cursor_shape_device_v1);
}

static inline int
maru_wp_cursor_shape_device_v1_add_listener(MARU_Context_WL *ctx, struct wp_cursor_shape_device_v1 *wp_cursor_shape_device_v1, const struct wp_cursor_shape_device_v1_listener *listener, void *data)
{
	return ctx->dlib.wl.proxy_add_listener((struct wl_proxy *) wp_cursor_shape_device_v1, (void (**)(void)) listener, data);
}

static inline void
maru_wp_cursor_shape_device_v1_destroy(MARU_Context_WL *ctx, struct wp_cursor_shape_device_v1 *wp_cursor_shape_device_v1)
{
...
static inline void
maru_wp_cursor_shape_device_v1_set_shape(MARU_Context_WL *ctx, struct wp_cursor_shape_device_v1 *wp_cursor_shape_device_v1, uint32_t serial, uint32_t shape)
{
