...
#ifndef MARU_WAYLAND_HELPERS_VIEWPORTER_H
#define MARU_WAYLAND_HELPERS_VIEWPORTER_H
...
static inline void
maru_wp_viewporter_set_user_data(MARU_Context_WL *ctx, struct wp_viewporter *wp_viewporter, void *user_data)
{
	ctx->dlib.wl.proxy_set_user_data((struct wl_proxy *) wp_viewporter, user_data);
}

static inline void *
maru_wp_viewporter_get_user_data(MARU_Context_WL *ctx, struct wp_viewporter *wp_viewporter)
{
	return ctx->dlib.wl.proxy_get_user_data((struct wl_proxy *) wp_viewporter);
}

static inline uint32_t
maru_wp_viewporter_get_version(MARU_Context_WL *ctx, struct wp_viewporter *wp_viewporter)
{
	return ctx->dlib.wl.proxy_get_version((struct wl_proxy *) wp_viewporter);
}

static inline int
maru_wp_viewporter_add_listener(MARU_Context_WL *ctx, struct wp_viewporter *wp_viewporter, const struct wp_viewporter_listener *listener, void *data)
{
	return ctx->dlib.wl.proxy_add_listener((struct wl_proxy *) wp_viewporter, (void (**)(void)) listener, data);
}

static inline void
maru_wp_viewporter_destroy(MARU_Context_WL *ctx, struct wp_viewporter *wp_viewporter)
{
...
maru_wp_viewporter_get_viewport(MARU_Context_WL *ctx, struct wp_viewporter *wp_viewporter, struct wl_surface *surface)
{
	struct wl_proxy *id;
...
static inline void
maru_wp_viewport_set_user_data(MARU_Context_WL *ctx, struct wp_viewport *wp_viewport, void *user_data)
{
	ctx->dlib.wl.proxy_set_user_data((struct wl_proxy *) wp_viewport, user_data);
}

static inline void *
maru_wp_viewport_get_user_data(MARU_Context_WL *ctx, struct wp_viewport *wp_viewport)
{
	return ctx->dlib.wl.proxy_get_user_data((struct wl_proxy *) wp_viewport);
}

static inline uint32_t
maru_wp_viewport_get_version(MARU_Context_WL *ctx, struct wp_viewport *wp_viewport)
{
	return ctx->dlib.wl.proxy_get_version((struct wl_proxy *) wp_viewport);
}

static inline int
maru_wp_viewport_add_listener(MARU_Context_WL *ctx, struct wp_viewport *wp_viewport, const struct wp_viewport_listener *listener, void *data)
{
	return ctx->dlib.wl.proxy_add_listener((struct wl_proxy *) wp_viewport, (void (**)(void)) listener, data);
}

static inline void
maru_wp_viewport_destroy(MARU_Context_WL *ctx, struct wp_viewport *wp_viewport)
{
...
static inline void
maru_wp_viewport_set_source(MARU_Context_WL *ctx, struct wp_viewport *wp_viewport, wl_fixed_t x, wl_fixed_t y, wl_fixed_t width, wl_fixed_t height)
{
...
static inline void
maru_wp_viewport_set_destination(MARU_Context_WL *ctx, struct wp_viewport *wp_viewport, int32_t width, int32_t height)
{
