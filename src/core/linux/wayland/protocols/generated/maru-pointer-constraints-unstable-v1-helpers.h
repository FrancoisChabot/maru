...
#ifndef MARU_WAYLAND_HELPERS_POINTER_CONSTRAINTS_UNSTABLE_V1_H
#define MARU_WAYLAND_HELPERS_POINTER_CONSTRAINTS_UNSTABLE_V1_H
...
static inline void
maru_zwp_pointer_constraints_v1_set_user_data(MARU_Context_WL *ctx, struct zwp_pointer_constraints_v1 *zwp_pointer_constraints_v1, void *user_data)
{
	ctx->dlib.wl.proxy_set_user_data((struct wl_proxy *) zwp_pointer_constraints_v1, user_data);
}

static inline void *
maru_zwp_pointer_constraints_v1_get_user_data(MARU_Context_WL *ctx, struct zwp_pointer_constraints_v1 *zwp_pointer_constraints_v1)
{
	return ctx->dlib.wl.proxy_get_user_data((struct wl_proxy *) zwp_pointer_constraints_v1);
}

static inline uint32_t
maru_zwp_pointer_constraints_v1_get_version(MARU_Context_WL *ctx, struct zwp_pointer_constraints_v1 *zwp_pointer_constraints_v1)
{
	return ctx->dlib.wl.proxy_get_version((struct wl_proxy *) zwp_pointer_constraints_v1);
}

static inline int
maru_zwp_pointer_constraints_v1_add_listener(MARU_Context_WL *ctx, struct zwp_pointer_constraints_v1 *zwp_pointer_constraints_v1, const struct zwp_pointer_constraints_v1_listener *listener, void *data)
{
	return ctx->dlib.wl.proxy_add_listener((struct wl_proxy *) zwp_pointer_constraints_v1, (void (**)(void)) listener, data);
}

static inline void
maru_zwp_pointer_constraints_v1_destroy(MARU_Context_WL *ctx, struct zwp_pointer_constraints_v1 *zwp_pointer_constraints_v1)
{
...
maru_zwp_pointer_constraints_v1_lock_pointer(MARU_Context_WL *ctx, struct zwp_pointer_constraints_v1 *zwp_pointer_constraints_v1, struct wl_surface *surface, struct wl_pointer *pointer, struct wl_region *region, uint32_t lifetime)
{
	struct wl_proxy *id;
...
maru_zwp_pointer_constraints_v1_confine_pointer(MARU_Context_WL *ctx, struct zwp_pointer_constraints_v1 *zwp_pointer_constraints_v1, struct wl_surface *surface, struct wl_pointer *pointer, struct wl_region *region, uint32_t lifetime)
{
	struct wl_proxy *id;
...
static inline void
maru_zwp_locked_pointer_v1_set_user_data(MARU_Context_WL *ctx, struct zwp_locked_pointer_v1 *zwp_locked_pointer_v1, void *user_data)
{
	ctx->dlib.wl.proxy_set_user_data((struct wl_proxy *) zwp_locked_pointer_v1, user_data);
}

static inline void *
maru_zwp_locked_pointer_v1_get_user_data(MARU_Context_WL *ctx, struct zwp_locked_pointer_v1 *zwp_locked_pointer_v1)
{
	return ctx->dlib.wl.proxy_get_user_data((struct wl_proxy *) zwp_locked_pointer_v1);
}

static inline uint32_t
maru_zwp_locked_pointer_v1_get_version(MARU_Context_WL *ctx, struct zwp_locked_pointer_v1 *zwp_locked_pointer_v1)
{
	return ctx->dlib.wl.proxy_get_version((struct wl_proxy *) zwp_locked_pointer_v1);
}

static inline int
maru_zwp_locked_pointer_v1_add_listener(MARU_Context_WL *ctx, struct zwp_locked_pointer_v1 *zwp_locked_pointer_v1, const struct zwp_locked_pointer_v1_listener *listener, void *data)
{
	return ctx->dlib.wl.proxy_add_listener((struct wl_proxy *) zwp_locked_pointer_v1, (void (**)(void)) listener, data);
}

static inline void
maru_zwp_locked_pointer_v1_destroy(MARU_Context_WL *ctx, struct zwp_locked_pointer_v1 *zwp_locked_pointer_v1)
{
...
static inline void
maru_zwp_locked_pointer_v1_set_cursor_position_hint(MARU_Context_WL *ctx, struct zwp_locked_pointer_v1 *zwp_locked_pointer_v1, wl_fixed_t surface_x, wl_fixed_t surface_y)
{
...
static inline void
maru_zwp_locked_pointer_v1_set_region(MARU_Context_WL *ctx, struct zwp_locked_pointer_v1 *zwp_locked_pointer_v1, struct wl_region *region)
{
...
static inline void
maru_zwp_confined_pointer_v1_set_user_data(MARU_Context_WL *ctx, struct zwp_confined_pointer_v1 *zwp_confined_pointer_v1, void *user_data)
{
	ctx->dlib.wl.proxy_set_user_data((struct wl_proxy *) zwp_confined_pointer_v1, user_data);
}

static inline void *
maru_zwp_confined_pointer_v1_get_user_data(MARU_Context_WL *ctx, struct zwp_confined_pointer_v1 *zwp_confined_pointer_v1)
{
	return ctx->dlib.wl.proxy_get_user_data((struct wl_proxy *) zwp_confined_pointer_v1);
}

static inline uint32_t
maru_zwp_confined_pointer_v1_get_version(MARU_Context_WL *ctx, struct zwp_confined_pointer_v1 *zwp_confined_pointer_v1)
{
	return ctx->dlib.wl.proxy_get_version((struct wl_proxy *) zwp_confined_pointer_v1);
}

static inline int
maru_zwp_confined_pointer_v1_add_listener(MARU_Context_WL *ctx, struct zwp_confined_pointer_v1 *zwp_confined_pointer_v1, const struct zwp_confined_pointer_v1_listener *listener, void *data)
{
	return ctx->dlib.wl.proxy_add_listener((struct wl_proxy *) zwp_confined_pointer_v1, (void (**)(void)) listener, data);
}

static inline void
maru_zwp_confined_pointer_v1_destroy(MARU_Context_WL *ctx, struct zwp_confined_pointer_v1 *zwp_confined_pointer_v1)
{
...
static inline void
maru_zwp_confined_pointer_v1_set_region(MARU_Context_WL *ctx, struct zwp_confined_pointer_v1 *zwp_confined_pointer_v1, struct wl_region *region)
{
