...
static void _maru_x11_clear_mime_query_cache(MARU_Context_X11 *ctx);
static void _maru_x11_clear_pending_request(MARU_Context_X11 *ctx,
                                            MARU_X11DataRequestPending *request);
static void _maru_x11_clear_offer(MARU_Context_X11 *ctx, MARU_X11DataOffer *offer);
static void _maru_x11_clear_dnd_session(MARU_Context_X11 *ctx);
static void _maru_x11_clear_dnd_source_session(MARU_Context_X11 *ctx,
                                                bool emit_finished,
                                                MARU_DropAction finished_action);
static bool _maru_x11_copy_string(MARU_Context_X11 *ctx, const char *src,
                                  char **out_str);
...
static Atom _maru_x11_target_to_selection_atom(const MARU_Context_X11 *ctx,
...
static MARU_DataExchangeTarget
...
static MARU_X11DataOffer *_maru_x11_get_offer(MARU_Context_X11 *ctx,
                                              MARU_DataExchangeTarget target) {
  if (target == MARU_DATA_EXCHANGE_TARGET_CLIPBOARD) {
...
static MARU_X11DataRequestPending *_maru_x11_get_pending_request(
...
static bool _maru_x11_set_dnd_selected_mime(MARU_Context_X11 *ctx,
...
static bool _maru_x11_dnd_store_offer_atoms(MARU_Context_X11 *ctx,
                                            MARU_X11DnDSession *session,
...
static bool _maru_x11_dnd_load_type_list(MARU_Context_X11 *ctx,
                                         MARU_X11DnDSession *session) {
...
static MARU_DropAction _maru_x11_atom_to_drop_action(const MARU_Context_X11 *ctx,
                                                      Atom atom) {
...
static Atom _maru_x11_drop_action_to_atom(const MARU_Context_X11 *ctx,
...
static void _maru_x11_dnd_set_position_from_packed(MARU_Context_X11 *ctx,
                                                   MARU_X11DnDSession *session,
                                                   long packed_xy) {
...
static const char *_maru_x11_dnd_first_mime(const MARU_X11DnDSession *session,
                                            Atom *out_atom) {
  if (out_atom) {
    *out_atom = None;
  }
...
static bool _maru_x11_dnd_find_mime(const MARU_X11DnDSession *session,
...
static uint32_t _maru_x11_parse_uri_list(MARU_Context_X11 *ctx, const char *data,
...
static void _maru_x11_send_xdnd_status(MARU_Context_X11 *ctx,
...
static void _maru_x11_send_xdnd_finished(MARU_Context_X11 *ctx,
                                         const MARU_X11DnDSession *session,
                                         bool accepted) {
  if (!session->source_window || !session->target_window) {
    return;
...
static MARU_DropAction _maru_x11_pick_allowed_action(MARU_DropActionMask mask) {
...
static void _maru_x11_send_xdnd_enter_source(MARU_Context_X11 *ctx, Window target,
...
static void _maru_x11_send_xdnd_leave_source(MARU_Context_X11 *ctx, Window target,
                                             Window source) {
  XEvent ev;
  memset(&ev, 0, sizeof(ev));
  ev.type = ClientMessage;
...
static void _maru_x11_send_xdnd_position_source(MARU_Context_X11 *ctx, Window target,
...
static void _maru_x11_send_xdnd_drop_source(MARU_Context_X11 *ctx, Window target,
...
static void _maru_x11_update_dnd_source_target(MARU_Context_X11 *ctx, Time event_time,
...
static void _maru_x11_send_net_wm_state_local(MARU_Context_X11 *ctx,
                                              MARU_Window_X11 *win,
...
static void _maru_x11_apply_size_hints_local(MARU_Context_X11 *ctx,
                                             MARU_Window_X11 *win) {
  XSizeHints hints;
...
static bool _maru_x11_is_text_mime(const char *mime) {
  if (!mime || mime[0] == '\0') {
    return false;
  }
...
static uint32_t _maru_x11_find_offer_mime_index(MARU_Context_X11 *ctx,
                                                 const MARU_X11DataOffer *offer,
...
static void _maru_x11_send_selection_notify(MARU_Context_X11 *ctx,
...
static void _maru_x11_process_event(MARU_Context_X11 *ctx, XEvent *ev) {
  ...
  switch (ev->type) {
    ...
    case ClientMessage: {
      ...
      if (message_type == ctx->wm_protocols &&
      ...
      } else if (message_type == ctx->xdnd_status) {
        MARU_X11DnDSourceSession *src = &ctx->dnd_source;
        ...
        drop_evt.drop.session_userdata = &session->session_userdata;
        drop_evt.drop.available_types.mime_types =
            (const char *const *)session->offered_mimes;
        drop_evt.drop.available_types.count = session->offered_count;
        drop_evt.drop.modifiers = 0;
        drop_evt.drop.paths = NULL;
        drop_evt.drop.path_count = 0;
        _maru_dispatch_event(&ctx->base, MARU_EVENT_DROP_DROPPED,
