...
typedef enum MARU_Key {
  ...
  MARU_KEY_KP_8 = 100,
  MARU_KEY_KP_9 = 101,
  MARU_KEY_KP_DECIMAL = 102,
  MARU_KEY_KP_DIVIDE = 103,
  MARU_KEY_KP_MULTIPLY = 104,
  MARU_KEY_KP_SUBTRACT = 105,
  MARU_KEY_KP_ADD = 106,
  MARU_KEY_KP_ENTER = 107,
  MARU_KEY_KP_EQUAL = 108,
  MARU_KEY_LEFT_SHIFT = 109,
  MARU_KEY_LEFT_CONTROL = 110,
  MARU_KEY_LEFT_ALT = 111,
  MARU_KEY_LEFT_META = 112,
  MARU_KEY_RIGHT_SHIFT = 113,
  MARU_KEY_RIGHT_CONTROL = 114,
  MARU_KEY_RIGHT_ALT = 115,
  MARU_KEY_RIGHT_META = 116,
  MARU_KEY_MENU = 117,
  MARU_KEY_COUNT = 118
} MARU_Key;
...
#define MARU_WINDOW_STATE_CHANGED_FOCUSED MARU_BIT32(2)
#define MARU_WINDOW_STATE_CHANGED_ICON MARU_BIT32(3)
#define MARU_WINDOW_STATE_CHANGED_RESIZABLE MARU_BIT32(4)
...
#define MARU_WINDOW_ATTR_DIP_MIN_SIZE MARU_BIT(6)
#define MARU_WINDOW_ATTR_DIP_MAX_SIZE MARU_BIT(7)
#define MARU_WINDOW_ATTR_DIP_VIEWPORT_SIZE MARU_BIT(8)
...
#define MARU_WINDOW_ATTR_DIP_TEXT_INPUT_RECT MARU_BIT(14)
#define MARU_WINDOW_ATTR_SURROUNDING_ANCHOR_BYTE MARU_BIT(15)
#define MARU_WINDOW_ATTR_SURROUNDING_TEXT MARU_BIT(16)
#define MARU_WINDOW_ATTR_SURROUNDING_CURSOR_BYTE MARU_BIT(17)
#define MARU_WINDOW_ATTR_VISIBLE MARU_BIT(18)
#define MARU_WINDOW_ATTR_ICON MARU_BIT(19)
...
/*
 * Looks up a live window handle by its stable ID.
 *
 * This is an owner-thread API.
 *
 * Returns:
 * - MARU_SUCCESS: if the window was found.
 * - MARU_FAILURE: if no window with that ID exists in the context.
 * - MARU_CONTEXT_LOST: if the context is lost.
 */
