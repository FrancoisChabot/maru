#include "../support/shared_renderer/vulkan_renderer.h"
#include "maru/maru.h"
...
int main(void) {
  ...
  create_info.tuning.wayland.decoration_strategy =
      MARU_WAYLAND_DECORATION_STRATEGY_AUTO;
  ...
  if (maru_createVkSurface(window, renderer.instance, vkGetInstanceProcAddr, &surface) !=
      MARU_SUCCESS) {
